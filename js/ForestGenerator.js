    ...
    function _buildForest() {
        ...
        for (i = 0; i < NUM_TREES; i++) {
            ...
            if (i % 3 == 0) {
                ...
                newTree.position.x = _r.randomSign(_r.random(0, 50) + (PATH_MODE ? _r.random(2,3) : 0));
                ...
                newTree.position.x = _r.randomSign(_r.random(10+i/3,60 + i) + (PATH_MODE ? _r.random(2,3) : 0));
            }
