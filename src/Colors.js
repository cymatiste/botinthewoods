...
function Colors() {
  ...
  this.randomPastel = function() {
    var randomR = Math.floor(190 + Math.random() * 65);
    var randomG = Math.floor(190 + Math.random() * 65);
    var randomB = Math.floor(190 + Math.random() * 65);
  ...
  this.randomBlue = function() {
    var randomR = Math.floor(0 + Math.random() * 150);
    var randomG = Math.floor(0 + Math.random() * 150);
    var randomB = Math.floor(0 + Math.random() * 255);
    var rgbObj = { r: randomR, g: randomG, b: randomB };
  ...
  this.almostBW = function() {
    return Math.random() < 0.1
      ? _this.randomHex(true)
      : Math.random() < 0.5
      ? _this.randomPastel()
      : _this.randomDarkGrey();
  };

  this.almostBlue = function() {
    return Math.random() < 0.1 ? _this.randomHex(true) : _this.randomBlue();
  };

  this.randomHex = function(override) {
    // greyout
    //return _this.variationsOn("#999999",25);

    if (!override) {
      //return _this.almostBW();
    }
  ...
  this.rgbToHex = function(rgbObj) {
    return (
      "#" +
      _componentToHex(rgbObj.r) +
      _componentToHex(rgbObj.g) +
      _componentToHex(rgbObj.b)
    );
  };
  ...
  this.addHexCols = function(colourStr1, colourStr2, proportion1, proportion2) {
    //console.log(" m i x i n g  "+colourStr1+" & "+colourStr2+", "+proportion1+" / "+proportion2);
    ...
    return _this.rgbToHex(rgbadded);
  };
